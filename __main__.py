# This file is part of SARKAR (Telegram Bot)
...
from SARKAR import TOKEN, bot, dp
from SARKAR.config import get_bool_key, get_list_key
from SARKAR.modules import ALL_MODULES, LOADED_MODULES, MOD_HELP
from SARKAR.utils.logger import log
...
if get_bool_key("LOAD_MODULES"):
    ...
    for module_name in modules:
        ...
        imported_module = import_module("SARKAR.modules." + module_name)
...
import_module("SARKAR.modules.pm_menu")
# Import misc stuff
import_module("SARKAR.utils.exit_gracefully")
if not get_bool_key("DEBUG_MODE"):
    import_module("SARKAR.utils.sentry")
